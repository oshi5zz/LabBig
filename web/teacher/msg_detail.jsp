...
<div id="page" class="contentFixWidth fix-width">
    ...
    <div id="main" class="bit_main_content">
        <div style="margin-left: 10%;width: 80%;margin-top: 20px;">
            <div >
                <span>消息内容</span><textarea class="form-message" readonly><s:property value="msg.main" /></textarea>
            </div>
            <form role="form" action="/teacher/sendMsg.action?stuid=<s:property value="stuid" />" method="post">
                <input type="hidden" name="msg.stuId" value="">
                <textarea name="msg.main" class="form-control " rows="4"></textarea>
                <br/>
                <div align="center">
                    <button type="submit" class="btn btn-lg btn-primary">回复</button>
                </div>
            </form>
